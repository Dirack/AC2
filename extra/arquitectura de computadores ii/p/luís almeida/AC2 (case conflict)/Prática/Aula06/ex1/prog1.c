...
int main(void){
  ...
  IEC1bits.AD1IE = 1;
  IPC6bits.AD1IP = 3; // por exemplo, pois como temos apenas uma coisa
                      // a correr nao interessa muito o valor
                      // tem é de ser entre 1 a 6.
...
/* inside of int(XXXXX) Replace vector by de A/D vector number
 - see "PIC32 family data sheet" (pages 122-124)*/
