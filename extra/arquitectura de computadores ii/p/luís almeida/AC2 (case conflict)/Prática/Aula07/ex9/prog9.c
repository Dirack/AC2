...
int main(void){
  ...
  // configurar os portos RE4 e RE5 como entrada
  TRISEbits.TRISE4 = 1;
  TRISEbits.TRISE5 = 1;
  TRISEbits.TRISE6 = 1;
  TRISEbits.TRISE7 = 1;
  ...
  IEC1bits.AD1IE = 1;
  IPC6bits.AD1IP = 1;       // por exemplo, pois como temos apenas uma
...
void setPWM(int dutyCycle){
  if(dutyCycle > 100 || dutyCycle < 0)  // range de dutyCycle [0, 100]
    exit(1);
